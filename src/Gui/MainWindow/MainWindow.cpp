...
const char COMMUNITY_FORUM_URL[] = "https://cryptoConstella.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://cryptoConstella.cl";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Constella Wallet %1").arg(Settings::instance().getVersion()));
