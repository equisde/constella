...
bool Currency::getBlockReward(uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
  ...
  // XCC REWARD CHANGES
  uint64_t baseReward;
  uint64_t factorCut = 44500000; // 0.445 XCC
  uint64_t coinCut_v1 = 264000000000000; // 2.64M XCC
  uint64_t coinCut_v2 = 292000000000000; // 2.92M XCC
  ...
  if (baseReward < subsidyTarget) {
	  baseReward = subsidyTarget; // Subsidy 0.20 XCC
  }
